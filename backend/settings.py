...
class _UiSettings(BaseSettings):
    ...
    title: str = "Fat Tailed AI"
    logo: Optional[str] = None
    chat_logo: Optional[str] = None
    chat_title: str = "How May I Help You?"
    chat_description: str = "This chatbot is configured to answer questions about Julia and Danny's Wedding."
